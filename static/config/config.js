...
const LOCALE_MAP = {
  "app": {
    "label": "应用设置",
    "api_key": { title: "API 密钥", desc: "调用 grok2api-appchat 服务所需的 Bearer Token，请妥善保管。" },
    "app_key": { title: "后台密码", desc: "登录 grok2api-appchat 管理后台的密码，请妥善保管。" },
    "app_url": { title: "应用地址", desc: "当前 grok2api-appchat 的外部访问 URL，用于文件链接访问。" },
